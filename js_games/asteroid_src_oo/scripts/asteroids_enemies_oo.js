...
class Asteroid  extends Game.EnemyActor
{
   constructor(p, v, s, t)
   {
      super( p, v);
 ...
 */
class EnemyShip extends Game.EnemyActor {
   ...
   constructor(scene, size) {
     ...
     */ 
      ...
      //this.animLength = EnemyShip.SHIP_ANIM_LENGTH;
      ...
      onUpdate(scene)
      {
         ...
         if (GameHandler.frameStart - this.bulletRecharge > this.BULLET_RECHARGE_MS && scene.player.alive)
         {
            ...
            var bullet = new EnemyBullet(this.position.clone(), v);
