...
// ## square  ###  lshape ##### flat  ## green  ##  red  #  yellow ### purple-cshape  #### purple-fshape 
// ##           #                    ##          ##     ###        # #                # #
...
var SHAPE_DESCRIPTORS = [
  { color: "olive",   orientations: [ [[0,0],[1,0],[0,1],[1,1]] ] },    // square 
  { color: "blue",   orientations: [ [[0,0],[1,0],[2,0],[2,1]],         // lshape
                                     [[1,0],[1,1],[1,2],[0,2]],
                                     [[0,0],[0,1],[1,1],[2,1]],
                                     [[0,0],[1,0],[0,1],[0,2]] ] },     // flatshape
  ...
  { color: "yellow", orientations: [ [[0,1],[1,1],[2,1],[1,0]],
                                     ...
                                     [[0,0],[1,0],[2,0],[1,1]],
                                     [[1,0],[1,1],[1,2],[0,1]] ] },
  { color: "lime", orientations: [ [[0,0],[0,1],[1,0],[2,0],[2,1]],   //cshape
                                     [[0,0],[1,0],[0,1],[0,2],[1,2]],
                                     [[0,0],[0,1],[1,1],[2,0],[2,1]],
                                     [[0,0],[1,0],[1,1],[0,2],[1,2]] ] }, 
/*  { color: "purple", orientations: [ [[0,0],[0,1],[1,1],[2,0],[2,1],[3,1]], //fshape
                                     [[1,0],[0,1],[1,1],[1,2],[1,3],[0,3]],
                                     [[0,0],[1,0],[2,0],[3,0],[1,1],[3,1]],
                                     [[0,0],[1,0],[0,1],[0,2],[1,2],[0,3]] ] }
*/
/*  { color: "teal",   orientations: [ [[1,0],[0,1],[1,1],[2,1],[1,2]]] }   star-shape */
];
